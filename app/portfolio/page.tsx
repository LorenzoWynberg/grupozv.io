      ...
      <section className="px-6 pt-32 pb-16">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="mt-6 max-w-3xl text-lg text-zinc-600 dark:text-zinc-400 md:text-xl">
            Experience-driven platforms powered by technology, data, and
            community. Each company operates independently at brand level, while
            benefiting from centralized ecosystem architecture.
          </p>
        </div>
      </section>
            ...
            <table className="w-full min-w-[800px] text-left text-sm">
              <thead>
                <tr className="border-b border-zinc-200 dark:border-zinc-800">
                  ...
                  <th className="pb-4 pr-4 font-semibold">Maturity</th>
                  <th className="pb-4 pr-4 font-semibold">Revenue Type</th>
                  <th className="pb-4 pr-4 font-semibold">Scalability</th>
      ...
      <section className="border-t border-zinc-200 px-6 py-24 dark:border-zinc-800">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="mt-12 text-center text-lg font-medium text-zinc-600 dark:text-zinc-400">
            This creates a feedback loop where each company strengthens the
            others.
          </p>
        </div>
      </section>
              ...
              >
                ...
                <div className="mt-4 border-t border-zinc-200 pt-4 dark:border-zinc-800">
                  <p className="text-xs text-zinc-500 dark:text-zinc-400">
                    <span className="font-medium">Strategic Role:</span>{" "}
                    {company.strategicRole}
                  </p>
                </div>
              </div>
      ...
      <section className="border-t border-zinc-200 bg-zinc-900 px-6 py-24 text-white dark:bg-zinc-50 dark:text-zinc-900">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-zinc-400 dark:text-zinc-600">
            Explore investment opportunities across the holding, specific
            verticals, or individual brands.
          </p>
          <Link
            href="/invest"
