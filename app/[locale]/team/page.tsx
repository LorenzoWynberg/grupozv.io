...
const teamMembers = [
  ...
  { name: 'Juan José López', role: 'Logistic Manager', photo: '/images/juan-jose.webp' },
  {
  ...
  { name: 'Lorenzo Wynberg', role: 'Senior Web Developer', photo: '/images/lore.webp' },
  { name: 'Daniel Hidalgo', role: 'Audiovisual Director', photo: null },
  { name: 'Fernando López', role: 'Vendor Coordinator', photo: '/images/fernando.webp' },
  { name: 'Sofía Rodríguez', role: 'Art and Design Coordinator', photo: '/images/sofia.webp' },
];
    ...
    <div className="min-h-screen">
      ...
      <section className="border-border border-t px-6 py-24 sm:px-10 lg:px-16">
        <div className="mx-auto max-w-6xl">
          <AnimatedSection>
            <SectionHeading label={t.leadership.label} title={t.leadership.title} align="center" />
          </AnimatedSection>
          <div className="mt-12 flex flex-wrap justify-center gap-12">
            {teamMembers.slice(0, 2).map((member, i) => (
              <AnimatedSection key={member.name} delay={i * 0.1}>
                <TeamCard
                  name={member.name}
                  role={t.roles[member.role] || member.role}
                  photo={member.photo}
                  className="w-48"
                />
              </AnimatedSection>
      ...
      <section className="border-border bg-muted/30 border-t px-6 py-24 sm:px-10 lg:px-16">
        <div className="mx-auto max-w-6xl">
          <AnimatedSection>
            <SectionHeading label={t.members.label} title={t.members.title} align="center" />
          </AnimatedSection>
